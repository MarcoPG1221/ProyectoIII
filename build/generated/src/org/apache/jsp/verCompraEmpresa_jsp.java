...
public final class verCompraEmpresa_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <li class=\"nav-item dropdown\">\n");
      out.write("                  <a class=\"nav-link dropdown-toggle\" href=\"#\" id=\"navbarDropdownMenuLink\" role=\"button\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">\n");
      out.write("                    Reportes de Ventas\n");
      out.write("                  </a>\n");
      out.write("                  <div class=\"dropdown-menu\" aria-labelledby=\"navbarDropdownMenuLink\">\n");
      out.write("                    <a class=\"dropdown-item\" href=\"verCompra.jsp\">Cliente Individual</a>\n");
      out.write("                    <a class=\"dropdown-item\" href=\"verCompraEmpresa.jsp\">Cliente Empresa</a>\n");
      out.write("                  </div>\n");
      out.write("                </li>\n");
      out.write("              </ul>\n");
      out.write("            </div>\n");
      ...
      out.write("            <h2>Ordenes de Clientes Empresa:</h2>\n");
      out.write("        </div>\n");
      ...
      out.write("                <th scope=\"col\">Fecha_Compra</th>\n");
      out.write("                <th scope=\"col\">Precio_Envio</th>\n");
      out.write("                <th scope=\"col\">Tipo_Envio</th>\n");
      out.write("                <th soope=\"col\">Dias_Envio</th>\n");
      ...
      out.write("                <th scope=\"col\">Nombre_producto</th>\n");
      out.write("                <th scope=\"col\">Precio_pro</th>\n");
      out.write("                <th scope=\"col\">Cantidad</th>\n");
      out.write("                <th scope=\"col\">Precio_Final</th>\n");
      ...
      out.write("              ");
              ...
              List<Orden> orden1 = facturaDAO.getDBOrdenes1();
      ...
      out.write("</td>\n");
      out.write("                <td>");
      out.print(o.getContacto() );
      out.write("</td>\n");
      out.write("                <td>");
      out.print(o.getEstado() );
      out.write("</td>\n");
      out.write("                <td>");
      out.print(o.getCodigo() );
      out.write("</td>\n");
      out.write("                <td>");
      out.print(o.getNombre_pro() );
      out.write("</td>\n");
      out.write("                <td>Q. ");
      out.print(o.getPrecio_pro() );
      out.write("</td>\n");
      out.write("                <td>");
      out.print(o.getCantidad() );
      out.write("</td>\n");
      out.write("                <td>Q. ");
      out.print(o.getTotal() );
      out.write("</td>\n");
      out.write("                <td>");
      out.print(o.getId_cliente() );
      out.write("</td>\n");
      out.write("              </tr>\n");
      out.write("              ");
      ...
      out.write("              <label for=\"c\">Eliminar Orden:</label>\n");
      ...
      out.write("                Se elimino orden correctamente <a href=\"verCompra.jsp\" class=\"alert-link\">Actualizar</a>. \n");
      out.write("            </div>\n");
      out.write("        ");
