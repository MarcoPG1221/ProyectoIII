<%-- 
    Document   : ReporteClienteEmpresa
    Created on : 25/10/2020, 04:11:02 PM
    Author     : pc
--%>
...
<html>
    ...
    <body>
        ...
        <div class="form-group col-md-6">
            <h2>Clientes registrados tipo Empresa:</h2>
        </div>
        <form action="ReporteClienteEmpresa.jsp" method="POST">
        <div class="form-group col-md-6">
        <table class="table table-striped">
            ...
            <tbody>
              ...
              List<Empresa> clientes = clientesDAO.getDBClienteEmpresa();
        ...
        <%
                ...
                clientesDAO.deleteClienteEmpresa(Integer.parseInt(codigo));
        %>
            <div class="alert alert-success" role="alert">
                Se elimino correctamente el cliente <a href="ReporteClienteEmpresa.jsp" class="alert-link">Actualizar</a>. 
            </div>
        <% 
            }
        %>    
