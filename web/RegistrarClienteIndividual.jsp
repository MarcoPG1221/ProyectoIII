<%-- 
    Document   : RegistrarClienteIndividual
    Created on : 25/10/2020, 11:35:16 AM
    Author     : pc
--%>
...
<html>
    ...
    <body>
        ...
        <div class="form-group col-md-6">
            <h2>Registro de Cliente Individual</h2>
        ...
        %>
        <form action="RegistrarClienteIndividual.jsp" method="POST">
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="dpi" name="dpi" placeholder="Ingrese su documento de idenficacion">
            </div>
            <div class="form-group col-md-6">    
        ...
        %>
            <div class="alert alert-success" role="alert">
                Se registro correctamente el cliente <a href="ReporteClientes.jsp" class="alert-link">Ver Clientes Registrados</a>. 
            </div>
        <%
            }
        %>
